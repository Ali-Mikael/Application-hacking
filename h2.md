...
- <img width="536" height="73" alt="Screenshot from 2026-01-22 18-07-50" src="https://github.com/user-attachments/assets/9af4193b-72a6-49f9-8051-7c64f4fb4452" />
...
**Try #3:**
- My next attempt was trying to crack it from the command line, and I found a super useful website explaining how to use `curl` to do a POST request
...
**Try #4:**     
I was still destined to circumvent the client-side validation and perform the injection attack, so I kept trying to change the input field type. (Which I later found out doesn't matter as long as you're able to input a string..)     
